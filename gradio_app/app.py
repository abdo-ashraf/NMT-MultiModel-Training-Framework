...
model_state_dict = torch.load("./out/models/en-ar_s2s.pth", map_location=device, weights_only=True)['model_state_dict']
...
model_state_dict = torch.load("./out/models/en-ar_transformer.pth", map_location=device, weights_only=True)['model_state_dict']
